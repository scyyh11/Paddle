...
function(cc_library TARGET_NAME)
  ...
  if(cc_library_SRCS)
    ...
    # Mark .mm files as Objective-C++ before creating the library
    if(APPLE)
      foreach(src_file ${cc_library_SRCS})
        get_filename_component(src_ext ${src_file} EXT)
        if(src_ext STREQUAL ".mm")
          set_source_files_properties(${src_file} PROPERTIES LANGUAGE OBJCXX)
        endif()
      endforeach()
    endif()
